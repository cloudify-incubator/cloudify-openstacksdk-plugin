...
from openstacksdk_plugin.resources.identity import project
...
class ProjectTestCase(OpenStackTestBase):
    ...
    @mock.patch(
        'openstacksdk_plugin.resources.identity.project._assign_users')
    @mock.patch(
        'openstacksdk_plugin.resources.identity.project._validate_users')
